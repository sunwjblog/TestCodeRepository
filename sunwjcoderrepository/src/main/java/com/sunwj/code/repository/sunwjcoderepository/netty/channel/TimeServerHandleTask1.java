...
public class TimeServerHandleTask1 implements Runnable  {
    SocketChannel socketChannel;
    ExecutorService executorService;
    ByteBuffer byteBuffer = ByteBuffer.allocateDirect(1024);

    public TimeServerHandleTask1(SocketChannel socketChannel, ExecutorService executorService) {
    ...
    public void run() {
        try {
            ...
            TimeServerHandleTask1 currentTask = new TimeServerHandleTask1(socketChannel,
                    executorService);
